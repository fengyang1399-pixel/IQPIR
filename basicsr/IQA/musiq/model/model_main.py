...
class Encoder(nn.Module):
    ...
    def forward(self, mask_inputs, feat_dis_org_embed, feat_dis_scale_1_embed, feat_dis_scale_2_embed):
        ...
        batch_size = mask_inputs.size()[0]
        scale_org_embed = repeat(self.scale_org_embedding, '() c () () -> b c h w', b=batch_size, h=16, w=16)
        scale_1_embed = repeat(self.scale_1_embedding, '() c () () -> b c h w', b=batch_size, h=12, w=12)
        scale_2_embed = repeat(self.scale_1_embedding, '() c () () -> b c h w', b=batch_size, h=5, w=7)
        ...
        spatial_org_embed = repeat(spatial_org_embed, '() c h w -> b c h w', b=batch_size)
        # scale 1
        ...
        spatial_scale_1_embed = repeat(spatial_scale_1_embed, '() c h w -> b c h w', b=batch_size)
        # scale 2
        ...
        spatial_scale_2_embed = repeat(spatial_scale_2_embed, '() c h w -> b c h w', b=batch_size)
