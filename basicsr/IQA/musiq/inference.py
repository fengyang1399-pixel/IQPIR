...
# configuration
config = Config({
    'gpu_id': 4,                                                        # specify gpu number to use
    'dirname': '/Disk/z30027263/AIGC-IQA/DATA/CanonR5_v1/',     # directory of data root
    'checkpoint': './model/musiq_koniq_ckpt-e95806b9.pth',                              # weights of trained model
...
#a = torch.rand(1,3,1024,1024).to(config.device)
#out = model_backbone(a)
#print(out.shape)#(1,2048,32,32)
#exit()
