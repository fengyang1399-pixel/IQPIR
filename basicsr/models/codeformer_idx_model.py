...
class CodeFormerIdxModel(SRModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        if self.generate_idx_gt:
            ...
            if self.hq_vqgan_fix.quantizer_type=='dual_codebook':
                _, _, quant_stats2 = self.hq_vqgan_fix.quantize_aesthetic(x)
                min_encoding_indices2 = quant_stats2['min_encoding_indices']
                self.idx_gt_aesthetic = min_encoding_indices2.view(self.b, -1)
